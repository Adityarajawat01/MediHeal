      ...
      <div className={footerStyles.mainContent}>
        <div className={footerStyles.gridContainer}>
          ...
          <div className={footerStyles.companySection}>
            <div className={footerStyles.logoContainer}>
              ...
              <div>
                <h2 className={footerStyles.companyName}>MediHeal</h2>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 8840531527</span>
              </div>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
              ...
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>Fatehpur, India</span>
              </div>
            </div>
          </div>
        ...
        <div className={footerStyles.bottomSection}>
          <div className={footerStyles.copyright}>
            <span>© {currentYear}  MediHeal Healthcare.</span>
          </div>
