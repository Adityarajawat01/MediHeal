...
export default function ContactPage() {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/8840531527?text=${encodeURIComponent(text)}`;
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>
              Radha Nagar, Fatehpur, Uttar Pradesh
            </p>
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> 8840531527
            </p>
            <p className={contactPageStyles.infoItem}>
              <Mail size={16} /> Mediheal.com
            </p>
          </div>

        <iframe
                  src="https://www.google.com/maps?q=Radha+Nagar+Fatehpur+Uttar+Pradesh&output=embed"
                 className={contactPageStyles.map}
                  title="Radha Nagar Map"
                  loading="lazy"
                   allowFullScreen
               ></iframe>
