...
const serviceAppointmentSchema = new mongoose.Schema({
  ...
  payment: {
    ...
    sessionId: {
      type: String,   // stripe session ID for online payments
        default: "",
      },
...
const ServiceAppointment = mongoose.model("ServiceAppointment", serviceAppointmentSchema) || mongoose.models.ServiceAppointment;
