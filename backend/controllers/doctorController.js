...
//helper functions
//this function converts time in "hh:mm AM/PM" format to total minutes for easy comparison and sorting
...
//this function accept the obj or Jsonatring
...
//this function takes the raw docotr data and convert into plain text 
...
export const getDoctors = async (req, res) => {
  try {
    ...
    const total = await Doctor.countDocuments(match); //total no. of doctor
...
export async function updateDoctor(req, res) {
  try {
    ...
    if (req.file?.path) {
      const uploaded = await upToCloudinary(req.file.path, "doctors");
      if (uploaded) {
